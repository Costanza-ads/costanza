...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-auth.ts [app-client] (ecmascript)"); // <-- IMPORTANTE
;
...
function LoginPage() {
    ...
    const { login, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            const response = await fetch("".concat(API_URL, "/api/auth/jwt/create/"), {
                method: 'POST',
                headers: {
    ...
    const handleSocialLogin = (provider)=>{
        ...
        window.location.href = "".concat(API_URL, "/api/auth/o/").concat(provider, "-oauth2/");
    };
...
//# sourceMappingURL=_b436fc91._.js.map