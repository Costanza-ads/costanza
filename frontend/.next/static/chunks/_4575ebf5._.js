...
function RegisterPage() {
    ...
    const handleRegister = async (e)=>{
        ...
        try {
            ...
            const response = await fetch("".concat(API_URL, "/api/auth/users/"), {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                if (data.email) {
                    setError("Email: ".concat(data.email.join(' ')));
                } else if (data.password) {
                    setError("Senha: ".concat(data.password.join(' ')));
                } else {
    ...
    const handleSocialLogin = (provider)=>{
        ...
        window.location.href = "".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL, "/api/auth/o/").concat(provider, "-oauth2/");
    };
...
_s(RegisterPage, "DtTRE3fweAJyictqdAwNMZaxv4M=", false, function() {
    return [
...
//# sourceMappingURL=_4575ebf5._.js.map